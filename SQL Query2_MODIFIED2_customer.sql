...
/**TOP 3 ACTION CHANGES --> TOP 3 OLD VALUES THAT WERE CHNAGED FREQUENTLY --> I CHOSE THIS AS IT MAKES SENSE TO CALCULATE MoM percentage on this **/
,cte1 as (
select  department,ca.ins_ts,month(ca.ins_ts) as month,ca.log_id,ca.old_value,ca.new_value from cte as c 
left join [dbo].[customer_action - customer_action] as ca on ca.user_id = c.user_id 
...
where crm.crm_object_name like 'customer'
